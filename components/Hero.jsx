...
const Hero = ({ featuredPosts }) => {
  ...
  let i = 0
  const dates = featuredPosts.map(() =>
    new Date(featuredPosts[i++].published_at).toLocaleDateString(
      "en-US",
      options
    )
  )
  ...
  return (
    <div className="hero">
      <div className="hero__left">
        <img
          src={`http://localhost:1337${featuredPosts[0].hero[0].formats.large.url}`}
          ...
          <a className="hero__link">
            <div className="hero__content-box">
              <span className="hero__tag">
                {featuredPosts[0].categories[0].category}
              </span>
              <h2 className="heading-secondary">{featuredPosts[0].title}</h2>
              <span className="hero__post-author">
      ...
      <div className="hero__right">
        <div className="hero__right--1">
          <img
            src={`http://localhost:1337${featuredPosts[1].hero[0].formats.medium.url}`}
          ...
          <Link href={`/post/${featuredPosts[1].id}`}>
            <a className="hero__link">
              <div className="hero__content-box">
                <span className="hero__tag">
                  {featuredPosts[1].categories[0].category}
                </span>
        ...
        <div className="hero__right--2">
          <img
            src={`http://localhost:1337${featuredPosts[2].hero[0].formats.medium.url}`}
          ...
          <Link href={`/post/${featuredPosts[2].id}`}>
            <a className="hero__link">
              <div className="hero__content-box">
                <span className="hero__tag">
                  {featuredPosts[2].categories[0].category}
                </span>
